...
def apr_repositories():
    ...
    #     http_archive,
    #     name = "org_apache_apr",
    #     build_file = Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/apr:BUILD.apr.bazel"),
    #     patches = [
    #         # https://bz.apache.org/bugzilla/show_bug.cgi?id=50146
    #         Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/apr:macos_iovec.patch"),
    #         # https://bz.apache.org/bugzilla/show_bug.cgi?id=64753
    #         Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/apr:macos_pid_t.patch"),
    #         # https://apachelounge.com/viewtopic.php?t=8260
    #         Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/apr:windows_winnt.patch"),
    #     ],
