...
def log4cxx_repositories():
    ...
    #     http_archive,
    #     name = "log4cxx",
    #     build_file = Label("@com.github.doevelopper.rules-infra//log4cxx:BUILD.log4cxx.bazel"),
    ...
    #         Label("@com.github.doevelopper.rules-infra//log4cxx:console.cpp.patch"),
    #         Label("@com.github.doevelopper.rules-infra//log4cxx:inputstreamreader.cpp.patch"),
    #         Label("@com.github.doevelopper.rules-infra//log4cxx:socketoutputstream.cpp.patch"),

    #         # Required for building on MacOS
    #         Label("@com.github.doevelopper.rules-infra//log4cxx:simpledateformat.h.patch"),
    #     ],
    #     urls = [
