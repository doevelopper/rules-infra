...
def opendds_repositories():
    ...
    maybe(
        ...
        build_file = Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/openDDS:ace_tao.BUILD"),
        # sha256 = "d4b01ed07fefbca56b8799e8a37e3fe466896701d9d08427d4ec7436c6d041ee",
        strip_prefix = "OpenDDS-3.23.1",
        urls = [
    ...
    maybe(
        ...
        build_file = Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/openDDS:XSC.BUILD"),
        # sha256 = "d4b01ed07fefbca56b8799e8a37e3fe466896701d9d08427d4ec7436c6d041ee",
        strip_prefix = "OpenDDS-3.23.1",
        urls = [
    ...
    maybe(
        ...
        build_file = Label("@com.github.doevelopper.rules-infra//src/main/resources/off_the_shelf_software/openDDS:CIAO.BUILD"),
        # sha256 = "d4b01ed07fefbca56b8799e8a37e3fe466896701d9d08427d4ec7436c6d041ee",
        strip_prefix = "OpenDDS-3.23.1",
        urls = [
