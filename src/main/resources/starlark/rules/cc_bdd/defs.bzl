...
gherkin_test = rule(
    ...
    attrs = {
        ...
        "_template": attr.label(
            ...
            default = Label("@com.github.doevelopper.rules-infra//src/main/resources/starlark/rules/cc_bdd:cc_gherkin_wire_test.sh.tpl"),
            allow_single_file = True,
        ),
...
_cc_gherkin_steps = rule(
    ...
    attrs = {
        ...
        "_template": attr.label(
            doc = "The template specification for the executable",
            default = Label("@com.github.doevelopper.rules-infra//src/main/resources/starlark/rules/cc_bdd:cc_gherkin_wire_steps.sh.tpl"),
            allow_single_file = True,
        ),
    },
    executable = True,
