...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com.github.doevelopper.rules-infra//src/main/resources/starlark/rules:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.rulesinfrainfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com.github.doevelopper.rules-infra//src/main/resources/starlark/rules:toolchain_type"],
...
# By default all these toolchains are registered by the rules_infra_register_toolchains macro
