...
log4cxx::LoggerPtr ConfigurableEventListener::logger = log4cxx::Logger::getLogger(
    std::string("com.github.doevelopper.rules.infra.extensions.test.ConfigurableEventListener"));

log4cxx::LoggerPtr ConfigurableEventListener::Builder::logger = log4cxx::Logger::getLogger(
    std::string("com.github.doevelopper.rules.infra.extensions.test.ConfigurableEventListener.Builder"));
...
ConfigurableEventListener::ConfigurableEventListener(
    ...
    const bool showInlineFailures, const bool showEnvironment, const bool showSkips)
