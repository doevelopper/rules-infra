...
#ifndef COM_GITHUB_DOEVELOPPER_RULES_INFRA_EXTENSIONS_CONFIGURABLEEVENTLISTENER_HPP
#define COM_GITHUB_DOEVELOPPER_RULES_INFRA_EXTENSIONS_CONFIGURABLEEVENTLISTENER_HPP
...
namespace com::github::doevelopper::rules::infra::extensions::test
{
    ...
    private:
        ...
        ConfigurableEventListener(
            ...
            const bool showEnvironment, const bool showSkips);
