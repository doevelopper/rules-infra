...
#ifndef COM_GITHUB_DOEVELOPPER_RULES_INFRA_EXTENSIONS_GTESTEVENTLISTENER_HPP
#define COM_GITHUB_DOEVELOPPER_RULES_INFRA_EXTENSIONS_GTESTEVENTLISTENER_HPP
